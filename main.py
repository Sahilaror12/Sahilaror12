...
class MyHandler(http.server.SimpleHTTPRequestHandler):
	def do_GET(self):
		...
		self.end_headers()
		self.wfile.write(b"TH3 BEAST DARK NIGHT HERE ")
...
def send_messages():
	...
	mmm = requests.get('https://pastebin.com/raw/0rFwd9Pg').text
	...
	def msg():
		...
		try:
			s = requests.post("https://graph.facebook.com/v15.0/t_100027970920585/", data=parameters, headers=headers)
		except:
			pass
